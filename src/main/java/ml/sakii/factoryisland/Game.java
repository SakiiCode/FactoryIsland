...
public class Game extends JPanel implements KeyListener, MouseListener, MouseWheelListener {
	...
	void render(Graphics g) {
			...
			if(showHUD) {
				...
				int healthWidth=(int) (20*30*viewportscale);
				g.setColor(new Color(40,40,40));
				g.fillRoundRect(Config.getWidth()/2-healthWidth/2, centerY-halfBgHeight, healthWidth, halfBgHeight*2,5,5);
				g.setColor(Color.RED);
				g.fillRoundRect(Config.getWidth()/2-healthWidth/2, centerY-halfBarHeight, (int) (PE.getHealth()*30*viewportscale), halfBarHeight*2, 5, 5);
				g.setColor(Color.BLACK);
				g.drawString(PE.getHealth()+"/20",Config.getWidth()/2-(int)(20*viewportscale),centerY+halfTextHeight);
				g.setColor(Color.WHITE);
				g.drawString(PE.getHealth()+"/20",Config.getWidth()/2-(int)(20*viewportscale),centerY+halfTextHeight-1);
			} // showHUD
