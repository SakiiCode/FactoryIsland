...
public class MainMenuGUI extends JPanel implements ActionListener{
	...
	public MainMenuGUI(){
		...
		"<li>Q - switch cursor between inventories</li><li>Middle Mouse - swap 1 item between inventories</li><li>F2 - save screenshot</li><li>F6 - open map to LAN multiplayer</li></ul>"
